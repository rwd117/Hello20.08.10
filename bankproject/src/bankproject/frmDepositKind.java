...
class frmDepositKind extends JInternalFrame implements ActionListener, WindowListener
{
   //=============  �뜲�씠�꽣踰좎씠�뒪 愿��젴 蹂��닔�뱾 ===============//
    ...
    // �뜲�씠�꽣踰좎씠�뒪�� �뿰怨꾪븯�뿬 �궗�슜�맆 蹂��닔�뱾 (�긽�뭹紐�, �긽�뭹援щ텇, 怨좉컼援щ텇)
    ...
    //=============  User Interface ===============//
    static JLabel label1 = new JLabel("�삁湲덉긽�뭹紐�");
    static JLabel label2 = new JLabel("�삁湲덊븳�룄");
    ...
    frmDepositKind(String title, Connection conn, JLabel lbMessage) {
        ...
        // �솕硫� �븯�떒�뿉 '�삁湲덉긽�뭹 愿�由�' display        
        lbStatusMessage.setText("�삁湲덉긽�뭹 愿�由�");
    ...
    public void clearItems() {
          ...
          jcb2.setSelectedIndex(0); // �긽�뭹援щ텇
    }
    ...
    public void setItems() {
        try {
            ...
            strDkname  = rs.getString(1).trim();    // �삁湲덉긽�뭹紐�
            lDklimit = rs.getLong(2);             // �삁湲덊븳�룄�븸
            strDkdist = rs.getString(3).trim();    // �긽�뭹援щ텇 A0, L1
            strDkcdist = rs.getString(4).trim();    // 怨좉컼援щ텇 00 媛쒖씤, 11 湲곗뾽
            iDkterm1 = rs.getInt(5);         		// 湲곌컙 1(媛쒖썡)
            fDkrate1 = rs.getFloat(6);       		// �씠�쑉 1
            iDkterm2 = rs.getInt(7);         		// 湲곌컙 2(媛쒖썡)
            fDkrate2 = rs.getFloat(8);       		// �씠�쑉 2
            iDkterm3 = rs.getInt(9);         		// 湲곌컙 3(媛쒖썡)
            fDkrate3 = rs.getFloat(10);       		// �씠�쑉 3
    ...
    public boolean getItems() {
        ...
        strDkname   = tf1.getText().trim();    				// �삁湲덉긽�뭹紐�
        lDklimit    = Long.parseLong(tf2.getText().trim()); 	// �삁湲덊븳�룄�븸
        iDkterm1    = Integer.parseInt(tf3.getText().trim());   	// 湲곌컙 1(媛쒖썡)
        fDkrate1    = Float.parseFloat(tf4.getText().trim());   	// �씠�쑉 1
        iDkterm2    = Integer.parseInt(tf5.getText().trim());   	// 湲곌컙 2(媛쒖썡)
        fDkrate2    = Float.parseFloat(tf6.getText().trim());   	// �씠�쑉 2
        iDkterm3    = Integer.parseInt(tf7.getText().trim());   	// 湲곌컙 3(媛쒖썡)
        fDkrate3    = Float.parseFloat(tf8.getText().trim());   	// �씠�쑉 3

        intIndex = jcb1.getSelectedIndex();

        // �엯�젰 textField�쓽 媛믪씠 �늻�씫�릺�뿀�뒗 �솗�씤
        if (strDkname == null) { msgBox("�삁湲덉긽�뭹紐낆씠 �늻�씫�릺�뿀�뒿�땲�떎."); return false; }
        if (iDkterm1 > 60 ) { msgBox("媛��뒫 湲곌컙�� 60媛쒖썡 誘몃쭔�엯�땲�떎."); return false; }
        if (iDkterm2 > 60 ) { msgBox("媛��뒫 湲곌컙�� 60媛쒖썡 誘몃쭔�엯�땲�떎."); return false; }
        if (iDkterm3 > 60 ) { msgBox("媛��뒫 湲곌컙�� 60媛쒖썡 誘몃쭔�엯�땲�떎."); return false; }

...
public class DepositKindPane extends JPanel implements ActionListener, KeyListener, MouseListener{
	...
	private String sqlTotal = "select item_name, item_limit, item_dist, item_c_dist, term1, rate1, term2, rate2, term3, rate3 from item where ITEM_DIST = 'A0'";
	...
	public void createItem(ResultSet rs) {
		try {
			...
			while(rs.next()) {
				...
				DepositItemPane item = new DepositItemPane(this, str, color[0][idx], color[1][idx]);

...
public class LoanItemPane extends JPanel implements MouseListener{
	...
	private String str;
	private String lblName[] = {"대출상품명", "대출한도", "상품구분", "고객구분", "기간1", "이율1", "기간2", "이율2", "기간3", "이율3"};
	...
	public LoanItemPane(JPanel pane, String str, Color background_color, Color font_color) {
	...
	public void eventLblDelete() {
		...
		if(check == 0) {
			if(checkUsing()) {
				...
				((LoanKindPane) superPane).eventBtnSelect();
			}
		}
	}
